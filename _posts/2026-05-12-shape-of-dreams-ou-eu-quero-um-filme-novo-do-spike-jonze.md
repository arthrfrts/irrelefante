...
Enquanto isso, nos resta o trabalho com publicidade dele. O mais recente é _Shape of Dreams_, que ele escreveu e dirigiu para a coleção de roupas que a Zendaya criou para a marca suíça On:

{% include link-preview.html link="https://youtu.be/6NVAzWEgTXo" reaction="like" %}
...
É do Jonze também a insana _Kenzo World_:

{% include link-preview.html link="https://youtu.be/mBdbJbEnTzI" reaction="like" %}

E a minha favorita das suas publicidades recentes, a _Welcome Home_ apresentando o primeiro HomePod da Apple. É genial tanto em ideia (uma simplicidade de dar inveja) e execução (maravilhosa, toda em efeitos práticos):

{% include link-preview.html link="https://youtu.be/b4m_TmC8OEw" reaction="like" %}

Lá vou eu rever _Quero Ser John Malkovich_.
