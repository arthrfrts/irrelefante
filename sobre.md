...
Esse blog consiste majoritariamente em quatro tipos de conteúdo: [textos](/textos/), [notas](/notas/), [links](/links/) e [reviews](/reviews/). “Textos” são as minhas próprias escritas, “notas” são observações breves do dia-a-dia, “links” apontam pra coisas legais ou interessantes que eu encontro (as vezes com comentários), e “reviews” são impressòes minhas sobre minha dieta cultural.

Eu gosto de escrever sobre vários tópicos, incluindo coisas estranhas que eu encontro enquanto navego na internet; a semântica da internet; teorias da comunicação, principalmente relacionadas aos limites da interpretação; cinema de maneira geral; novidades no desenvolvimento front-end; e conexões entre como a gente experimenta a cultura hoje em dia. Eu tento organizar tudo em assuntos relacionados através de tags. Você pode conferir uma lista completa delas no [arquivo]({% link arquivo.html %}).

Esse blog inclui textos muito antigos que podem ser difíceis de ler por serem confusos. Com o tempo, eu acredito que fui me tornando um escritor melhor por simplificar meu texto. Me desculpe por ser prolixo no início.

## Como usar esse site

Você pode navegar pelas páginas do blog e pelos posts na ordem que você quiser. Se algum texto depende do outro, isso geralmente é indicado por um link.

O Irrelefante tem poucos recursos por natureza. Você pode navegar por ele clicando em links de tags, de outros posts, ou explorando o [arquivo]({% link arquivo.html %}), que também inclui um recurso de busca bem simples.

Você também pode acompanhar esse blog por RSS. O Irrelefante tem vários feeds disponíveis:

- [Feed global](/feed.xml), com todos os posts publicados no blog
- [Textos](/feed/textos.xml), só com os textos mais formados
- [Notas](/feed/notas.xml), se por algum acaso você quer acompanhar só as observações mais breves
...
A última vez que ele foi atualizado foi em {{ 'now' | date: "%d/%m/%Y às %H:%M" }}.
